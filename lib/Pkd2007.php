...
final class Pkd2007
{
    ...
    public const MIGRATE = [
        Pkd2025::class => [
            '01.13.Z' => ['01.13.Z', '01.19.Z', '01.28.Z'],
            '01.41.Z' => ['01.41.Z', '01.42.Z'],
            '01.47.Z' => ['01.47.Z', '01.49.Z', '01.62.Z'],
            '01.48.Z' => ['01.49.Z', '03.22.Z'],
            '01.63.Z' => ['01.63.Z', '01.64.Z'],
            '03.30.Z' => ['03.11.Z', '03.12.Z', '03.21.Z', '03.22.Z', '33.11.Z'],
            '10.61.Z' => ['10.61.Z', '10.86.Z'],
            '10.62.Z' => ['10.62.Z', '10.86.Z'],
            '10.71.Z' => ['10.71.Z', '10.86.Z'],
            '10.72.Z' => ['10.72.Z', '10.86.Z'],
            '10.73.Z' => ['10.73.Z', '10.86.Z'],
            '10.89.A' => ['10.89.Z'],
            '10.89.B' => ['10.89.Z'],
            '10.89.C' => ['10.89.Z'],
            '10.89.D' => ['10.89.Z'],
            '11.07.Z' => ['10.89.Z', '11.07.Z'],
            '13.10.Z' => ['13.10.A', '13.10.B', '13.10.C', '13.10.D'],
            '13.20.Z' => ['13.20.A', '13.20.B', '13.20.C', '13.20.D'],
            '13.30.Z' => ['13.30.Z', '18.12.Z'],
            '13.96.Z' => ['13.20.D', '13.92.Z', '13.96.Z'],
            '14.10.Z' => ['14.13.Z', '14.14.Z', '14.19.Z', '14.31.Z', '14.39.Z'],
            '14.21.Z' => ['14.13.Z', '14.14.Z', '14.19.Z'],
            '14.22.Z' => ['14.14.Z', '14.19.Z'],
            '14.23.Z' => ['14.12.Z'],
            '14.24.Z' => ['14.11.Z', '14.20.Z'],
            '14.29.Z' => ['14.19.Z'],
            '15.20.Z' => ['15.20.Z', '16.29.Z', '22.19.Z', '22.29.Z'],
            '16.11.Z' => ['16.10.Z'],
            '16.12.Z' => ['16.10.Z'],
            '16.25.Z' => ['16.23.Z'],
            '16.26.Z' => ['16.29.Z'],
            '16.27.Z' => ['16.21.Z', '16.22.Z', '16.23.Z', '16.24.Z', '16.29.Z'],
            '16.28.Z' => ['16.29.Z'],
            '17.25.Z' => ['17.29.Z'],
            '18.12.Z' => ['18.12.Z', '74.20.Z', '82.19.Z'],
            '20.14.Z' => ['20.11.Z', '20.14.Z'],
            '20.16.Z' => ['20.16.Z', '38.32.Z'],
            '20.20.A' => ['20.20.Z'],
            '20.20.B' => ['20.20.Z'],
            '20.20.C' => ['20.20.Z'],
            '20.51.Z' => ['20.14.Z', '20.59.Z'],
            '20.59.Z' => ['20.51.Z', '20.52.Z', '20.53.Z', '20.59.Z'],
            '22.12.Z' => ['22.19.Z'],
            '22.21.Z' => ['22.21.Z', '22.29.Z'],
            '22.24.Z' => ['22.23.Z'],
            '22.25.Z' => ['22.21.Z', '22.22.Z', '22.23.Z', '22.29.Z'],
            '22.26.Z' => ['22.29.Z'],
            '23.15.Z' => ['23.19.Z'],
            '23.45.Z' => ['23.49.Z'],
            '23.66.Z' => ['22.23.Z', '23.69.Z'],
            '23.70.A' => ['23.70.Z'],
            '23.70.B' => ['23.70.Z'],
            '23.99.Z' => ['13.20.D', '23.99.Z'],
            '24.54.B' => ['24.53.Z', '24.54.B'],
            '25.21.Z' => ['25.21.Z', '25.30.Z'],
            '25.22.Z' => ['25.29.Z'],
            '25.30.Z' => ['25.40.Z'],
            '25.40.Z' => ['25.50.Z'],
            '25.51.Z' => ['25.61.Z'],
            '25.52.Z' => ['25.61.Z'],
            '25.53.Z' => ['25.61.Z', '25.62.Z'],
            '25.61.Z' => ['25.71.Z'],
            '25.62.Z' => ['25.72.Z'],
            '25.63.Z' => ['25.73.Z'],
            '26.20.Z' => ['26.20.Z', '28.23.Z'],
            '26.40.Z' => ['26.20.Z', '26.40.Z'],
            '26.51.Z' => ['26.30.Z', '26.51.Z'],
            '26.60.Z' => ['26.60.Z', '32.50.Z'],
            '26.70.Z' => ['26.70.Z', '26.80.Z'],
            '27.11.Z' => ['27.11.Z', '27.12.Z', '27.90.Z'],
            '27.90.Z' => ['27.90.Z', '28.49.Z'],
            '28.21.Z' => ['25.21.Z', '28.21.Z'],
            '28.25.Z' => ['28.21.Z', '28.25.Z'],
            '28.30.Z' => ['28.30.Z', '28.92.Z'],
            '28.41.Z' => ['28.41.Z', '28.49.Z'],
            '28.42.Z' => ['28.49.Z'],
            '28.93.Z' => ['28.29.Z', '28.93.Z'],
            '28.97.Z' => ['28.96.Z', '28.99.Z'],
            '29.10.A' => ['27.11.Z', '29.10.A'],
            '29.31.Z' => ['27.90.Z', '29.31.Z'],
            '29.32.Z' => ['23.12.Z', '28.11.Z', '28.25.Z', '29.32.Z'],
            '30.13.Z' => ['30.11.Z'],
            '30.31.Z' => ['30.30.Z'],
            '30.32.Z' => ['30.30.Z'],
            '30.91.Z' => ['28.11.Z', '30.91.Z'],
            '30.92.Z' => ['30.91.Z', '30.92.Z'],
            '31.00.Z' => ['23.42.Z', '31.01.Z', '31.02.Z', '31.03.Z', '31.09.Z'],
            '32.50.A' => ['32.50.Z'],
            '32.50.B' => ['32.50.Z', '32.99.Z'],
            '32.99.Z' => ['27.90.Z', '32.30.Z', '32.99.Z'],
            '33.15.Z' => ['33.12.Z', '33.15.Z'],
            '33.17.Z' => ['33.11.Z', '33.17.Z'],
            '33.18.Z' => ['30.40.Z', '33.12.Z', '33.15.Z', '33.16.Z'],
            '35.12.A' => ['35.11.Z'],
            '35.12.B' => ['35.11.Z'],
            '35.12.C' => ['35.11.Z'],
            '35.12.D' => ['35.11.Z'],
            ...
            '35.16.Z' => ['35.11.Z'],
            '35.24.Z' => ['52.10.A'],
            '35.40.Z' => ['35.14.Z', '35.23.Z'],
            '38.21.Z' => ['38.21.Z', '38.31.Z', '38.32.Z'],
            '38.22.Z' => ['38.21.Z', '38.22.Z'],
            '38.23.Z' => ['38.21.Z', '38.22.Z'],
            '38.31.Z' => ['38.21.Z', '38.22.Z'],
            '38.32.Z' => ['38.21.Z', '38.22.Z'],
            '38.33.Z' => ['38.21.Z', '38.22.Z'],
            '41.00.A' => ['41.20.Z'],
            '41.00.B' => ['41.20.Z'],
            '42.99.Z' => ['42.99.Z', '43.99.Z'],
            '43.22.Z' => ['43.22.Z', '43.99.Z'],
            '43.23.Z' => ['43.29.Z', '43.39.Z', '43.99.Z'],
            '43.24.Z' => ['43.29.Z'],
            '43.31.Z' => ['43.31.Z', '43.39.Z'],
            '43.32.Z' => ['43.32.Z', '43.39.Z'],
            '43.33.Z' => ['43.33.Z', '43.39.Z'],
            '43.34.Z' => ['43.34.Z', '43.39.Z'],
            '43.35.Z' => ['43.39.Z', '43.99.Z'],
            '43.41.Z' => ['43.91.Z', '43.99.Z'],
            '43.42.Z' => ['43.99.Z'],
            '43.50.Z' => ['42.11.Z', '43.99.Z'],
            '43.60.Z' => ['82.99.Z'],
            '43.91.Z' => ['43.99.Z'],
            '43.99.Z' => ['41.20.Z', '43.99.Z'],
            '46.11.A' => ['46.11.Z', '82.99.Z'],
            '46.11.B' => ['46.11.Z', '82.99.Z'],
            '46.12.Z' => ['46.12.Z', '82.99.Z'],
            '46.13.Z' => ['46.13.Z', '82.99.Z'],
            '46.14.Z' => ['46.14.Z', '82.99.Z'],
            '46.15.Z' => ['46.15.Z', '82.99.Z'],
            '46.16.Z' => ['46.16.Z', '82.99.Z'],
            '46.17.Z' => ['46.17.Z', '82.99.Z'],
            '46.18.Z' => ['45.11.Z', '45.19.Z', '45.31.Z', '45.40.Z', '46.18.Z', '82.99.Z'],
            '46.19.Z' => ['46.19.Z', '82.99.Z'],
            '46.21.A' => ['46.21.Z'],
            '46.21.B' => ['46.21.Z'],
            '46.32.Z' => ['46.32.Z', '46.38.Z'],
            '46.47.Z' => ['46.47.Z', '46.65.Z'],
            '46.49.Z' => ['46.43.Z', '46.49.Z'],
            '46.50.Z' => ['46.51.Z', '46.52.Z', '46.66.Z'],
            '46.64.Z' => ['46.43.Z', '46.64.Z', '46.69.Z'],
            '46.71.Z' => ['45.11.Z', '45.19.Z'],
            '46.72.Z' => ['45.31.Z'],
            '46.73.Z' => ['45.40.Z'],
            '46.81.Z' => ['46.71.Z'],
            '46.82.Z' => ['46.72.Z'],
            ...
            '46.87.Z' => ['46.77.Z'],
            '46.89.Z' => ['*'],
            '47.11.Z' => ['47.11.Z', '47.81.Z', '47.91.Z', '47.99.Z'],
            '47.12.Z' => ['47.19.Z', '47.82.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.21.Z' => ['47.21.Z', '47.81.Z', '47.91.Z', '47.99.Z'],
            '47.22.Z' => ['47.22.Z', '47.81.Z', '47.91.Z', '47.99.Z'],
            '47.23.Z' => ['47.23.Z', '47.81.Z', '47.91.Z', '47.99.Z'],
            '47.24.Z' => ['47.24.Z', '47.81.Z', '47.91.Z', '47.99.Z'],
            '47.25.Z' => ['47.25.Z', '47.81.Z', '47.91.Z', '47.99.Z'],
            '47.26.Z' => ['47.26.Z', '47.81.Z', '47.91.Z', '47.99.Z'],
            '47.27.Z' => ['47.29.Z', '47.81.Z', '47.91.Z', '47.99.Z'],
            '47.40.Z' => ['47.41.Z', '47.42.Z', '47.43.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.51.Z' => ['47.51.Z', '47.82.Z', '47.91.Z', '47.99.Z'],
            '47.52.Z' => ['47.52.Z', '47.59.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.53.Z' => ['47.53.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.54.Z' => ['47.54.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.55.Z' => ['47.59.Z', '47.78.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.61.Z' => ['47.61.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.62.Z' => ['47.62.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.63.Z' => ['47.64.Z', '47.78.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.64.Z' => ['47.65.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.69.A' => ['47.59.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.69.B' => ['47.78.Z', '47.91.Z', '47.99.Z'],
            '47.69.C' => ['47.63.Z', '47.78.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.71.Z' => ['47.71.Z', '47.82.Z', '47.91.Z', '47.99.Z'],
            '47.72.Z' => ['47.72.Z', '47.82.Z', '47.91.Z', '47.99.Z'],
            '47.73.Z' => ['47.73.Z', '47.91.Z'],
            '47.74.Z' => ['47.74.Z', '47.78.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.75.Z' => ['47.75.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.76.A' => ['47.76.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.76.B' => ['47.76.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.77.Z' => ['47.77.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.78.Z' => ['47.78.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.79.A' => ['47.79.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.79.B' => ['47.79.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.79.C' => ['47.79.Z', '47.82.Z', '47.89.Z', '47.91.Z', '47.99.Z'],
            '47.81.Z' => ['45.11.Z', '45.19.Z'],
            '47.82.Z' => ['45.32.Z'],
            '47.83.Z' => ['45.40.Z'],
            '47.91.Z' => ['47.11.Z', '47.19.Z', '47.79.Z', '47.91.Z', '47.99.Z', '82.99.Z'],
            '47.92.Z' => ['45.11.Z', '45.19.Z', '45.32.Z', '45.40.Z', '47.21.Z', '47.22.Z', '47.23.Z', '47.24.Z', '47.25.Z', '47.26.Z', '47.29.Z', '47.30.Z', '47.41.Z', '47.42.Z', '47.43.Z', '47.51.Z', '47.52.Z', '47.53.Z', '47.54.Z', '47.59.Z', '47.61.Z', '47.62.Z', '47.63.Z', '47.64.Z', '47.65.Z', '47.71.Z', '47.72.Z', '47.73.Z', '47.74.Z', '47.75.Z', '47.76.Z', '47.77.Z', '47.78.Z', '47.79.Z', '47.91.Z', '47.99.Z', '82.99.Z'],
            '49.11.Z' => ['49.10.Z'],
            '49.12.Z' => ['49.10.Z', '49.31.Z'],
            '49.31.Z' => ['49.31.Z', '49.39.Z'],
            '49.32.Z' => ['49.39.Z'],
            '49.33.Z' => ['49.32.Z'],
            '49.34.Z' => ['49.31.Z', '49.39.Z'],
            '52.10.A' => ['52.10.B'],
            '52.21.A' => ['52.21.Z'],
            '52.21.B' => ['52.21.Z'],
            '52.24.C' => ['49.41.Z', '52.24.C'],
            '52.25.Z' => ['52.29.A', '52.29.B', '52.29.C'],
            '52.26.Z' => ['52.29.A', '52.29.B', '52.29.C'],
            '52.31.Z' => ['52.29.A', '52.29.B', '52.29.C'],
            '52.32.Z' => ['49.32.Z', '52.29.A', '52.29.B', '52.29.C', '79.11.A', '79.11.B', '79.90.C'],
            '53.20.Z' => ['53.20.Z', '96.01.Z'],
            '53.30.Z' => ['82.99.Z'],
            '55.40.Z' => ['79.11.A', '79.11.B', '79.90.C'],
            '55.90.Z' => ['55.90.Z', '68.20.Z'],
            '56.11.Z' => ['56.10.A'],
            '56.12.Z' => ['56.10.B'],
            '56.22.Z' => ['56.29.Z'],
            '56.40.Z' => ['79.90.C'],
            '58.12.Z' => ['58.13.Z'],
            '58.13.Z' => ['58.14.Z'],
            '58.19.Z' => ['58.12.Z', '58.19.Z'],
            '60.20.Z' => ['60.20.Z', '63.11.Z'],
            '60.31.Z' => ['63.91.Z'],
            '60.39.Z' => ['47.91.Z', '63.11.Z', '63.12.Z'],
            '61.10.A' => ['61.10.Z', '61.20.Z', '61.30.Z'],
            '61.10.B' => ['61.10.Z', '61.20.Z', '61.30.Z'],
            '61.20.Z' => ['61.90.Z', '82.99.Z'],
            '61.90.A' => ['61.90.Z'],
            '61.90.B' => ['61.20.Z', '61.90.Z'],
            '62.10.A' => ['62.01.Z'],
            '62.10.B' => ['62.01.Z'],
            '62.20.A' => ['62.02.Z'],
            '62.20.B' => ['62.02.Z', '62.03.Z'],
            '62.90.Z' => ['62.09.Z'],
            '63.10.A' => ['63.11.Z'],
            '63.10.B' => ['63.11.Z'],
            '63.10.C' => ['63.11.Z'],
            '63.10.D' => ['52.10.B', '63.11.Z'],
            '63.91.Z' => ['63.12.Z'],
            '63.92.Z' => ['63.99.Z'],
            '64.21.Z' => ['64.20.Z'],
            '64.22.Z' => ['64.20.Z', '64.99.Z'],
            '64.31.Z' => ['64.30.Z'],
            '64.32.Z' => ['64.30.Z'],
            '64.92.A' => ['64.92.Z'],
            '64.92.B' => ['64.92.Z', '64.99.Z'],
            '66.30.Z' => ['66.19.Z', '66.30.Z'],
            '68.11.Z' => ['68.10.Z'],
            '68.12.A' => ['41.10.Z'],
            '68.12.B' => ['41.10.Z'],
            '68.12.C' => ['41.10.Z', '42.99.Z'],
            '68.32.A' => ['68.31.Z'],
            '68.32.B' => ['68.32.Z'],
            '68.32.C' => ['68.31.Z', '68.32.Z'],
            '69.20.A' => ['69.20.Z'],
            '69.20.B' => ['69.20.Z'],
            '69.20.C' => ['69.20.Z'],
            '70.10.A' => ['70.10.Z'],
            ...
            '71.12.B' => ['71.12.Z'],
            '71.20.C' => ['71.20.B'],
            '72.10.Z' => ['72.11.Z', '72.19.Z'],
            '73.12.Z' => ['73.12.A', '73.12.B', '73.12.C', '73.12.D'],
            '73.30.A' => ['70.21.Z'],
            '73.30.B' => ['70.21.Z'],
            '74.11.Z' => ['74.10.Z'],
            '74.12.Z' => ['74.10.Z'],
            ...
            '74.91.Z' => ['74.90.Z'],
            '74.99.Z' => ['74.90.Z'],
            '77.11.Z' => ['77.11.Z', '77.12.Z', '77.39.Z'],
            '77.12.Z' => ['77.12.Z', '77.39.Z'],
            '77.22.Z' => ['77.22.Z', '77.29.Z'],
            '77.40.A' => ['77.40.Z'],
            '77.40.B' => ['77.40.Z'],
            '77.51.Z' => ['79.11.A', '79.11.B', '79.90.C', '82.99.Z'],
            '77.52.Z' => ['82.99.Z'],
            '78.20.Z' => ['78.20.Z', '78.30.Z'],
            '79.11.Z' => ['79.11.A', '79.11.B'],
            '79.90.Z' => ['79.90.A', '79.90.B', '79.90.C'],
            '80.01.Z' => ['80.10.Z', '80.30.Z'],
            '80.09.Z' => ['74.90.Z', '80.20.Z'],
            '81.22.A' => ['81.22.Z'],
            '81.22.B' => ['43.39.Z', '43.99.Z', '81.22.Z'],
            '81.23.A' => ['81.29.Z'],
            '81.23.B' => ['81.29.Z'],
            '82.10.Z' => ['82.11.Z', '82.19.Z'],
            '82.40.Z' => ['79.90.C', '82.99.Z'],
            '82.91.Z' => ['82.91.Z', '82.99.Z'],
            '82.99.A' => ['82.99.Z'],
            '82.99.B' => ['82.99.Z'],
            '84.25.Z' => ['84.25.Z', '93.29.B'],
            '85.31.Z' => ['85.31.A', '85.31.B'],
            '85.32.C' => ['85.32.D'],
            '85.32.D' => ['85.32.C'],
            '85.33.A' => ['85.41.A'],
            '85.33.B' => ['85.41.B'],
            ...
            '91.21.C' => ['91.02.Z'],
            '91.22.Z' => ['91.03.Z'],
            '91.30.Z' => ['33.19.Z', '41.20.Z', '90.03.Z'],
            '91.41.A' => ['91.04.Z'],
            '91.41.B' => ['91.04.Z'],
            '91.42.Z' => ['91.04.Z'],
            '93.11.Z' => ['93.11.Z', '93.29.B'],
            '93.12.Z' => ['93.11.Z', '93.12.Z', '93.29.B'],
            '93.13.Z' => ['85.51.Z', '93.13.Z'],
            '93.19.Z' => ['93.19.Z', '93.29.B'],
            '93.29.A' => ['93.11.Z', '93.29.A'],
            '93.29.B' => ['82.30.Z', '93.19.Z', '93.21.Z', '93.29.B'],
            '95.10.Z' => ['95.11.Z', '95.12.Z'],
            '95.31.A' => ['45.20.Z'],
            '95.31.B' => ['45.20.Z'],
            '95.31.C' => ['45.20.Z'],
            '95.32.Z' => ['45.40.Z'],
